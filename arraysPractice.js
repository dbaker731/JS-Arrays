...
function divider( numbersArray ) {
  ...
  totalArray.push(evensArray);
  totalArray.push(oddsArray);
  return totalArray;
...
console.log( finderTest( numbers ) );
...
function removeItem( myGroceryList, removeFromList) {
  var remove = myGroceryList.indexOf(removeFromList);
  if (i !== -1) {
